...
echo "  curl -X POST http://localhost:5500/initialize    # Probar API"
echo "  curl -X POST -d '{\"state\":true}' -H 'Content-Type: application/json' http://localhost:5500/led"
...
echo -e "${GREEN}5. Probar API:${NC}               curl -X POST http://localhost:5500/initialize"
echo ""
echo "=================================================="
